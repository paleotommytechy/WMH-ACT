  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-neutral-100">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-xl font-bold">Daily Accountability</h2>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl focus:ring-2 focus:ring-violet-500 outline-none transition-all resize-none"
        ...
        <div>
          ...
          <div className="relative">
            <LinkIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-neutral-400" size={18} />
            <input
              type="url"
              required
              value={proofUrl}
              onChange={(e) => setProofUrl(e.target.value)}
              className="w-full pl-10 pr-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl focus:ring-2 focus:ring-violet-500 outline-none transition-all"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full md:w-auto bg-violet-600 hover:bg-violet-700 text-white font-bold px-8 py-3 rounded-xl transition-all shadow-md shadow-violet-100 flex items-center justify-center gap-2 disabled:opacity-50"
        >
